    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/funciones/nuevo", "/funciones/editar/**", "/funciones/eliminar/**").hasRole("ADMIN")
                        .requestMatchers("/peliculas/nuevo", "/peliculas/editar/**", "/peliculas/eliminar/**").hasRole("ADMIN")

                        // acceso a la lista (reservas, clientes, habitaciones) tanto USER como ADMIN
                        .requestMatchers("/", "/funciones/lista", "/clientes/lista", "/peliculas/lista").hasAnyRole("USER", "ADMIN")
